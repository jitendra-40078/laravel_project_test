...
class RoleController extends Controller
{
  ...
  private $rightsCollection = [
    [
      "section" => "Media Library Group",
      "permissions" => ["media group add", "media group update", "media group delete"]
    ],
    [
      "section" => "Media Library",
      "permissions" => ["media add", "media update", "media delete"]
    ]
  ];
