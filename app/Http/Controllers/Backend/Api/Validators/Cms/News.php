...
class News
{
  public static function rules($request, $language, $type, $recordId)
  {
    $rules = [
      ...
      'type' => 'bail|required|in:press,news',
      'is_featured' => 'bail|nullable|in:Y,N',
    ...
    if( $type === 'existing' ){
      ...
      $rules['name'] = 'bail|required|unique:news,name,'.$recordId.'|string|max:500';
    }else{
      $rules['name'] = 'bail|required|unique:news,name|string|max:500';
    }
  ...
  public static function messages($request)
  {
    $messages = [
      ...
      'name.string' => 'The title must be string.',
      ...
      'shortDescEn.alpha_string' => 'The description must be string.',
      ...
      'shortDescKr.alpha_string' => 'The description must be string.',
