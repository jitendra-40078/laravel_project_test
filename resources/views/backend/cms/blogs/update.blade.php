        ...
        <form id="blogUpdateForm">
          ...
          <div class="card-header py-3 bg-transparent">
            <div class="d-sm-flex align-items-center">
              <h5 class="mb-2 mb-sm-0">UPDATE BLOG</h5>
            </div>
          </div>
          ...
          <div class="card-body">
            ...
            @include('backend.cms.blogs.components.basic', $blogData)

            @include('backend.cms.blogs.components.english.form', $blogData)
            
            @include('backend.cms.blogs.components.korean.form', $blogData)
