        ...
        <form id="productAddForm">
          ...
          <div class="card-header py-3 bg-transparent">
            <div class="d-sm-flex align-items-center">
              <h5 class="mb-2 mb-sm-0">ADD PRODUCT</h5>
            </div>
          </div>
          
          <div class="card-body">

            @include('backend.cms.product.components.basic')

            @include('backend.cms.product.components.english.form')
            
            @include('backend.cms.product.components.korean.form')
