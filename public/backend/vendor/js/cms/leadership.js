...
$(document).ready(function() {
  ...
  if( typeof isListPage  !== 'undefined' && isListPage  === '1' ){
    ...
    setDataTable("leadershipTable", tableColumns);
    ...
    $(".deleteBtn").on("click", function(e){
      ...
      deleteRecord(routes.LEADERSHIP_DELETE, formdata);
    });
  }
  ...
  if( typeof isFormPage  !== 'undefined' && isFormPage === '1' ){
    ...
    if( typeof isEditFormPage  !== 'undefined' && isEditFormPage === '1' ){
      $("#leadershipUpdateForm").on("submit",function(e){
        e.preventDefault();        
        ...
        postForm(routes.LEADERSHIP_UPDATE, formData);
      });
    }else{
      $("#leadershipAddForm").on("submit", function(e){
        e.preventDefault();        
        ...
        const formData = new FormData(this);
        postForm(routes.LEADERSHIP_ADD, formData);
      });
    }
